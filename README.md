...
- [ ] Stabilize the **non-linear backtesting approach**. An earlier implementation was wired up but proved flaky; it needs to be made reliable before it becomes the default path.
